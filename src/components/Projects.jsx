              ...
              <h1 className="font-bold text-xl pt-10 pb-2 underline">DISH Technologies</h1>
                <p className="pb-2">Innovation Management Platform Landing Page For Hardware Engineering</p>
                  <img className="rounded-2xl pb-2" src={aboutImg} alt="about" />
                    <span className="mr-2 rounded bg-neutral-900 px-2 py-1 text-sm font-medium text-neutral-100">Design</span>
                    <span className="mr-2 rounded bg-neutral-900 px-2 py-1 text-sm font-medium text-neutral-100">Development</span>
                    <span className="mr-2 rounded bg-neutral-900 px-2 py-1 text-sm font-medium text-neutral-100">2024</span>
            </div>
